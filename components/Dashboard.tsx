  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {/* Main Level Card */}
        <div className="col-span-1 sm:col-span-2 bg-gradient-to-br from-blue-900/40 to-indigo-900/20 backdrop-blur-xl p-6 rounded-3xl border border-blue-500/20 shadow-lg relative overflow-hidden group">
      ...
      <div className="bg-gray-900/40 backdrop-blur-xl p-6 md:p-8 rounded-3xl border border-white/5 shadow-2xl relative">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-3 md:gap-4">
              {ACHIEVEMENTS.map((achievement) => {
                  ...
                  return (
                      ...
                      >
                          {isUnlocked ? (
                              <div className="mb-2 md:mb-3 p-2 md:p-3 bg-yellow-500/10 rounded-full ring-1 ring-yellow-500/50 group-hover:scale-110 transition-transform duration-300">
                                  <Icon className="w-5 h-5 md:w-6 md:h-6 text-yellow-400" />
                              </div>
                          ) : (
                              <div className="mb-2 md:mb-3 p-2 md:p-3 bg-gray-800 rounded-full">
                                  <Lock className="w-5 h-5 md:w-6 md:h-6 text-gray-600" />
                              </div>
                          )}
                          
                          <h4 className={`text-[10px] md:text-xs font-bold mb-1 ${isUnlocked ? 'text-white' : 'text-gray-500'}`}>
                              {achievement.title}
                          </h4>
                          <span className="text-[9px] md:text-[10px] text-gray-500 font-mono">+{achievement.xpReward} XP</span>
                      </div>
                  );
              })}
          </div>
